<?php
    ...
    $companies = $admin->getUnverifiedCompanies($search);
        ...
        <div class = "Body">
            ...
            <div class = "Main_Content">
                ...
                <section class = "Title">
                    ...
                    <h1> Unverified Companies </h1>

                </section>

                <div class = "Table_Container">

                    <form method = "GET" action = "CDC_UV_Companies.php">

                        <input id = "searchInput" type="text" name = "search" placeholder = "Search Company Name" value="<?= htmlspecialchars($search); ?>">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <div class = "Actions_Btn">
                                                ...
                                                <a class = "Verify_Btn" href = "CDC_UV_Companies_Verify.php?id=<?= $row['company_id'] ?>"> Verify </a>
                                                <a class = "Delete_Btn" href = "CDC_UV_Companies_Delete.php?id=<?= $row['company_id'] ?>" onclick = "return confirm('Are you sure you want to delete this company?');"> Delete </a>
