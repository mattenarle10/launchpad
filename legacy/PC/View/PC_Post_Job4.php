<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST')
    {
        ...
        $_SESSION['job_responsibilities'] = $_POST['job_responsibilities'];

        header("Location: PC_Post_Job5.php");
        exit();
    }
                    ...
                    <div class = "Form_Cont4">
                        ...
                        <form id = "Notif_Form" method = "POST">
                            ...
                            <div class = "Form2">
                                ...
                                <label for="subject"> Job Responsibilities </label>
                                <textarea name = "job_responsibilities" required></textarea>

                            </div>
                            
                            <button type = "submit" class = "Submit_Btn4"> Next </button>
