<?php
    ...
    {
        $_SESSION['job_pay_min'] = $_POST['job_pay_min'];
        $_SESSION['job_pay_max'] = $_POST['job_pay_max'];

        header("Location: PC_Post_Job4.php");
        exit();
    }
                    ...
                    <div class = "Form_Cont3">
                        ...
                        <form id = "Notif_Form" method = "POST">
                            ...
                            <div class = "Form1">
                                ...
                                <input type = "number" name = "job_pay_min" required>
                            ...
                            <div class = "Form2">
                                ...
                                <input type = "number" name = "job_pay_max" required>

                            </div>
                            
                            <button type = "submit" class = "Submit_Btn3"> Next </button>
