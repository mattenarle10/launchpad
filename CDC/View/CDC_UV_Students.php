<?php
    ...
    $students = $admin->getUnverifiedStudents($search);
        ...
        <div class = "Body">
            ...
            <div class = "Main_Content">
                ...
                <div class = "Table_Container">
                    ...
                    <form method = "GET" action = "CDC_UV_Students.php">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <div class = "Actions_Btn">
                                                ...
                                                <a class = "Verify_Btn" href = "CDC_UV_Students_Verify.php?id=<?= $row['student_id'] ?>"> Verify </a>
                                                <a class = "Delete_Btn" href = "CDC_UV_Students_Delete.php?id=<?= $row['student_id'] ?>" onclick = "return confirm('Are you sure you want to delete this student?');"> Delete </a>
